...
describe('SelectedMedicationRequestItem', () => {
  ...
  describe('Label Visibility (BAH-4705)', () => {
    it('should display visible labels for all form fields', async () => {
      ...
      expect(screen.getByRole('spinbutton', { name: 'Dosage' })).toBeInTheDocument();
      expect(screen.getByRole('combobox', { name: 'Dosage Unit' })).toBeInTheDocument();
      ...
      expect(screen.getByRole('combobox', { name: 'Instructions' })).toBeInTheDocument();
