const createMockEncounterEntry = (overrides: {
  id: string;
  versionId: string;
  lastUpdated: string;
  ...
  fullUrl: `http://localhost/openmrs/ws/fhir2/R4/Encounter/${overrides.id}`,
  resource: {
...
export const mockVisitBundle = {
  ...
  entry: [
    createMockEncounterEntry({
      ...
      visitTypeCode: 'b7494a80-fdf9-49bb-bb40-396c47b40343',
      visitTypeDisplay: 'IPD',
      period: { start: '2025-04-08T10:14:51+00:00' },
    }),
    createMockEncounterEntry({
