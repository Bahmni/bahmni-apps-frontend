...
describe('Observations', () => {
  ...
  describe('View mode switching (hideFormName)', () => {
    it('should render ObsByEncounterAndForm when hideFormName is false', async () => {
    ...
    it('should render ObsByEncounterAndForm when hideFormName is undefined', async () => {
      mockSearchConceptByName.mockResolvedValue({
        uuid: 'concept-uuid-1',
        display: 'Temperature',
      } as any);
    ...
    it('should render ObsByEncounter when hideFormName is true', async () => {
      mockSearchConceptByName.mockResolvedValue({
        uuid: 'concept-uuid-1',
        display: 'Temperature',
      } as any);
      ...
      const { container } = createWrapper(<Observations config={config} />);

      await waitFor(() => {
        expect(
          container.querySelector('#obs-by-encounter'),
        ).toBeInTheDocument();
      });
    });
  });
